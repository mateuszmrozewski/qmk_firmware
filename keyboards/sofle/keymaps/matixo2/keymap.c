...
[_QWERTY] = LAYOUT(
  ...
  QK_CAPS_WORD_TOGGLE,  LT(_NUMPAD, KC_Z),   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  QK_CAPS_WORD_TOGGLE,
                 KC_LALT,KC_LGUI,KC_LGUI,   KC_SPC,XXXXXXX,         LT(_NUMPAD, KC_ENT),  OSL(_SYMBOL), TT(_NAVIGATE), KC_RGUI, KC_RALT
),
...
[_NUMPAD] = LAYOUT(
  _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
    ...
    _______,  XXXXXXX,   KC_F1,  KC_F2,  KC_F3,   KC_F12, KC_MUTE,     XXXXXXX,           XXXXXXX,  KC_1,   KC_2,  KC_3,  KC_UNDERSCORE, XXXXXXX,
                       _______, _______, TO(_QWERTY),   KC_SPC, _______,      LT(_NUMPAD, KC_ENT),   OSL(_SYMBOL), TO(_NAVIGATE), _______, _______
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_SYMBOL] = LAYOUT(
  _______, _______ , _______ , _______ , _______ , _______,                           _______,  _______  , _______,  _______ ,  _______ ,_______,
    ...
    KC_KB_MUTE,    KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE,  _______, _______,  KC_BACKSLASH,
                         _______, _______, TO(_QWERTY),   KC_SPC, _______,       LT(_NUMPAD, KC_ENT),  TO(_NUMPAD), TO(_NAVIGATE), _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
